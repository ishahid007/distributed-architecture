...
function processUserCheckout($data){
    ...
    $data['data_type'] = 'processUserCheckout';
    $data = json_encode($data);
    // data to be sent is ['order_id' => 1, 'product_id' => 1, 'quantity' => 10, 'data_type' => 'processUserCheckout']
